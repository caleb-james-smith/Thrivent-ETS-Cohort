...
export default function CourseCard({ course, selectedCourse, updateSelectedCourse }: CourseProps) {
    return (
        <div className="course-card">
            ...
            {selectedCourse && selectedCourse.id === course.id && <CourseDetails {...course} />}
        </div>
    );
}